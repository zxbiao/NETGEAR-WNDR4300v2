...
#define CFG_IMAGE_LEN             0x1140000
...
#define WLAN_ON_OFF_SW_GPIO  1   /* WLAN Button (Input Pin/Active LOW) */
#define WPS_SW_GPIO          3   /* WPS Button (Input Pin/Active LOW) */
#define TEST_LED_GPIO       11   /* test led, green (Output Pin/Active LOW) */
...
/* LED registers on AR8035 */
#define AR8035_LED_OVERRIDE_REG           0x19

/*
 * definitions of pins belonging to AR8035_LED_OVERRIDE_REG
 * 
 * (AR8035_LED_10_100M_CTL, AR8035_LED_10_100M) = result
 *   (1, 0) = LED_10_100M switched off
 *   (1, 1) = LED_10_100M switched on
 */
#define AR8035_LED_10_100M_CTL            7
#define AR8035_LED_10_100M                6
...
#include <cmd_confdefs_hw29764676p0p128p128p2x2p2x2.h>
