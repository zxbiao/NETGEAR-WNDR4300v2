...
#include <atheros_hw29764733p4p0p32p2x2p0.h>
...
#include <cmd_confdefs_hw29764733p4p0p32p2x2p0.h>
...
/*
 * It's HW_ID should be "29764733+4+0+32+2x2+0".
...
#define GPIO_WPS_LED	0
#define GPIO_LAN_LED	1
#define GPIO_OPTION_LED 2
#define GPIO_PWR_GLED	11
#define GPIO_PWR_ALED	12
#define GPIO_MASTER_MODE_LED	13
#define GPIO_WIRELESS_LED	14
#define ALL_LED_GPIO_MASK \
	(1 << GPIO_WPS_LED | 1<< GPIO_LAN_LED | 1 << GPIO_OPTION_LED | \
	 1 << GPIO_PWR_GLED | 1 << GPIO_PWR_ALED | \
	 1 << GPIO_MASTER_MODE_LED | 1 << GPIO_WIRELESS_LED)
